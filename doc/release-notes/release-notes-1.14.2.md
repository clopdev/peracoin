Peracoin Core version 1.14.2 is now available from:

  <https://github.com/peracoin/peracoin/releases/tag/v1.14.2/>
...
Peracoin Core introduces pruning the blockchain in 1.14. Pruning
...
When Peracoin Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Peracoin-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Peracoin Core. This was added in conjunction with
