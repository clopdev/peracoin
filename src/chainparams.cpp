...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Peracoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Peracoin values
        ...
        vSeeds.push_back(CDNSSeedData("multipera.org", "seed.multipera.org", true));
        vSeeds.push_back(CDNSSeedData("multipera.org", "seed2.multipera.org"));
        ...
        //TODO: fix this for peracoin -- plddr
