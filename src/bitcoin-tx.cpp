...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s peracoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  peracoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded peracoin transaction") + "\n" +
              "  peracoin-tx [options] -create [commands]   " + _("Create hex-encoded peracoin transaction") + "\n" +
              "\n";
