...
### How much pera can exist? – So many puppies! 🐕
...
Peracoin uses a simplified variant of the scrypt key derivation function as its
proof of work with a target time of one minute per block and difficulty
readjustment after every block. The block rewards are fixed and halve every
100,000 blocks. Starting with the 600,000th block, a permanent reward of
10,000 Peracoin per block will be issued.  
...
100,000–144,999: 0–500,000 Peracoin

145,000–199,999: 250,000 Peracoin

200,000–299,999: 125,000 Peracoin

300,000–399,999: 62,500 Peracoin
...
### Wow plz make Peracoind/Peracoin-cli/Peracoin-qt
...
Run with the `-testnet` option to run with "play Peracoins" on the test network, if you
...
Peracoin Core is a multithreaded application, and deadlocks or other multithreading bugs
